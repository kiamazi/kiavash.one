...
فرمول‌های ریاضی را به صورت در خط و بلوکی میتوان نمایش داد. در حال حاضر مارک مود تنها از MathML2 پشتیبانی میکند. --(اگر از فایرفاکس استفاده می‌کنید فرمول‌ها رو کامل و صحیح میبینید، سایر مرورگها پشتیبانی کامل از MathML ندارند)--
